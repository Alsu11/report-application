...
type QuestionFormGroupContent = {
  ...
  answers: FormControl<IQuestion['answers']>;
  points: FormControl<IQuestion['points']>;
  testId: FormControl<IQuestion['testId']>;
};
...
export class QuestionFormService {
  createQuestionFormGroup(question: QuestionFormGroupInput = { id: null }): QuestionFormGroup {
    ...
    return new FormGroup<QuestionFormGroupContent>({
      ...
      answers: new FormControl(questionRawValue.answers),
      points: new FormControl(questionRawValue.points),
      testId: new FormControl(questionRawValue.testId),
    });
  }
